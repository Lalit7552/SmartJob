...
const UPLOAD_ROOT = path.join(__dirname, "..", "uploads", "worker-assets");
...
const uploadWorkerAssets = multer({
  ...
  fileFilter,
  limits: {
    fileSize: Number(process.env.WORKER_ASSET_MAX_BYTES || 3 * 1024 * 1024),
    files: 1,
  },
});

module.exports = { uploadWorkerAssets, UPLOAD_ROOT };
